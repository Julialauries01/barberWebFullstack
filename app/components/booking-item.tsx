   ...
   <p className="text-sm">{format(booking.date, "hh:mm")}</p>
         ...
         <SheetContent className="px-0">
            <SheetHeader className="px-5 text-left pb-6 border-b border-solid border-secondary">
               <SheetTitle>Informações da Reservaa </SheetTitle>
            </SheetHeader>

<div className="px-5">
<div className="relative h-[180px] w-full mt-6">
               <Image src="/map-barbershop.png"  className="rounded-lg" fill alt={booking.barbershop.name}
               />
...
<Card>
      ...
      style: "currency",
      currency: "BRL", }).format(Number(booking.service.price))}</h3>
            </div>
  ...
  <AlertDialogContent className="w-[90%]">
    <AlertDialogHeader>
      <AlertDialogTitle>Deseja mesmo cancelar esta reserva?</AlertDialogTitle>
      <AlertDialogDescription>
Após cancelar a reserva não será possivel reverter esta ação     
 </AlertDialogDescription>
    </AlertDialogHeader>
